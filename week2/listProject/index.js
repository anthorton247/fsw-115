var ghibliCharacters = [
    ...
    },
    {
      ...
      names: "Renaldo Moon aka Moon aka Muta",
      gender: "Male",
      age: "NA",
      eye_color: "White",
      hair_color: "Beige",
    ...
    },
    {
      ...
      names: "Baron Humbert von Gikkingen",
      gender: "Male",
      age: "NA",
      eye_color: "Green",
      hair_color: "Yellow",
...
for (var i = 0; i < ghibliCharacters.length; i++) {
  var ghibliList = document.getElementById("ghibli")
  var newCharacter = document.createElement("li")
  newCharacter.innerHTML = "Name: " + ghibliCharacters[i].names + "<br />Gender: " + ghibliCharacters[i].gender + "<br />Age:  " + ghibliCharacters[i].age + "<br />Eye Color: " + ghibliCharacters[i].eye_color + "<br />Hair Color: " + ghibliCharacters[i].hair_color 
  ghibliList.append(newCharacter)
}
